        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('clubmanagerApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-clubmanagerApp-error');
                                var entityKey = httpResponse.headers('X-clubmanagerApp-params');
                                if (errorHeader) {
